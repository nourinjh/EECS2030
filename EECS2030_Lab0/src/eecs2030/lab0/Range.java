...
public class Range {
	...
	/**
	 * Returns the string representation of a range. The string contains the minimum
	 * and maximum values separated by a comma and space all inside of a pair of
	 * square brackets. For example, the string
	 * 
	 * <p>
	 * <code>[-3.14, 3.14]</code>
	 * 
