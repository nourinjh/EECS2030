public interface Dictionary {
	 ...
	 *             if the input word does not exist
	 */
	String getDefinition(String word) throws WordNotInDictionaryException;
	 ...
	 *            an input word
	 * @param definition
	 *            associated definition of the input word
	 * @throws WordAlreadyExistsInDictionaryException
	 *             if the new word already exists in the dictionary
	 * @throws DictionaryFullException
	 *             if the dictionary already stores the maximum number of entries
	 */
	 ...
	 * @throws WordNotInDictionaryException
	 *             if the input `word` exists in the dictionary
	 */
	String removeWord(String word) throws WordNotInDictionaryException;
