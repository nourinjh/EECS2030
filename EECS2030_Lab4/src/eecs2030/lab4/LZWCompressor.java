...
public class LZWCompressor {
	 ...
	 * 
	 * @param input
	 *            a string representing an input sequence of characters to be
	 *            encoded/decoded
	 * 
	 * @throws an
	 ...
	 * 
	 * @param encoded
	 *            a list of integers representing a sequence of codes (indexes of
	 *            character patterns) learned by an LZWDictionary during the
	 *            encoding process
	 * 
	 * @return a string representation of the decoded input sequence
	 * 
	 * @throws an
	 *             IllegalArgumentException if encoded is an empty list
	 * 
	 */
